...
@section('content')
    <section class="container-question">
        <div class="rd-container">
            ...
            <div class="rd-element rd-s-100">
                <h2 class="text-color-blue-bold title-300-1-5em">¿Qué es lo que más le importa?</h2>
            </div>
        </div>
    </section>
    <div class="rd-container">
        <div class="rd-element rd-s-100 t-center">
            <h2 class="text-color-blue-bold title-300-1-5em">Condiciones de bioseguridad</h2>
        </div>
    </div>
    ...
    <div class="rd-container">
        <div class="rd-element rd-s-100 t-center">
            <h2 class="text-color-blue-bold title-300-1-5em">Condiciones de aprendizaje y estudio</h2>
        </div>
    </div>
    ...
    <div class="rd-container">
        <div class="rd-element rd-s-100 t-center">
            <h2 class="text-color-blue-bold title-300-1-5em">Condiciones de trabajo de los padres o cuidadores</h2>
        </div>
    </div>
    ...
    <div class="rd-container">
        <div class="rd-element rd-s-100 t-center title-400-2em">
            <h2 class="text-color-blue-bold title-300-1-5em">Condiciones del hogar</h2>
        </div>
    </div>
